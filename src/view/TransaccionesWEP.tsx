...
const TransaccionesWEP: React.FC<TransaccionesWEPProps> = ({
  ...
  return (
    <div className="p-4">
      {/* Line Chart */}
      <div
        className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4 "
        style={{ height: "auto" }}
      >
        <div
          className=" bg-card p-4 rounded-lg shadow hover:shadow-xl transition-shadow duration-300 col-span-3  bg-white  bg-white"
          style={{
        ...
        <div
          className=" bg-card p-4 rounded-lg shadow hover:shadow-xl transition-shadow duration-300 col-span-1  bg-white "
          style={{
            borderLeft: "4px solid #78BE20",
            paddingLeft: "10px",
            height: "250px",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4">
        <div
          ...
          style={{
            height: "387px",
            borderLeft: "4px solid #78BE20",
            paddingLeft: "10px", // Altura del contenedor principal
          }}
        >
          {allTransactions.length === 0 || emptyData ? (
            <EmptyData message="No existen datos de transacciones para las fechas seleccionadas" />
            ...
            <div className="h-full">
              {" "}
              {/* Asegúrate de que el div use toda la altura disponible */}
              <BarChart
        ...
        <div
          className=" bg-white p-4 rounded-lg shadow hover:shadow-xl transition-shadow duration-300 col-span-1  "
          style={{ borderLeft: "4px solid #78BE20", paddingLeft: "10px" }}
        >
          <DoughnutChart
